define(function (require) {
  ...
  require('bower_components/hogan.js/lib/template');
  require('bower_components/hogan.js/lib/compiler');
  ...
  function hogan() {
     ...
     * @param data.renderParams {Options} data
     * @param data.partials {Options} partials
     * @returns {*}
     */
    this.renderNamedTemplate = function (data) {
      ...
      if (compiledTemplate) {
        // return rendered template
        return compiledTemplate.render(data.renderParams, data.partials);
      } else {
        // throw error
      }
    };
     ...
     * @param data.partials {Options} template partials
     */
